import type { PassportVisaDisplayGroup, PassportVisaSeedItem } from './passportVisaSeed';
...
export function buildPassportVisaLegendFilterItems(countries: PassportVisaSeedItem[]) {
