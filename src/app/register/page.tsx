...
const authBase = apiBase.endsWith('/api') ? apiBase : `${apiBase}/api`;

const REGISTER_URL = usesRemoteHttpApi ? `${authBase}/auth/register` : `/api/auth/register`;
  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      ...
      if (usesRemoteHttpApi) {
        setError('注册成功但未返回 token：请更新 trip-backend（register 响应需含 token）');
        return;
      }
