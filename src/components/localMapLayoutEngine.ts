...
const DISPLAY_RADIUS_RATIO = 0.96;
const BASE_LAYOUT_LAYER_STEP = 28;
const RECT_EXTENSION_STEP = 28;
const RECT_EXTENSION_LIMIT = 56;
const RECT_CLEARANCE_PADDING = 10;
const RECT_TIGHTEN_ITERATIONS = 14;
const NEIGHBOR_MIN_GAP = 42;
const NEIGHBOR_RELAX_PASSES = 10;
const NEIGHBOR_ANGLE_DEGREES = [12, 8, 4, 2];
const NEIGHBOR_LENGTH_FACTORS = [0.88, 0.94, 0.98, 1];
const ANGLE_OPTIMIZE_DEGREES = [12, 8, 4, 2];
const ANGLE_OPTIMIZE_PASSES = 5;
const LINKED_LENGTH_FACTORS = [1, 0.94, 0.88, 0.82];
const GROUP_ANGLE_DEGREES = [8, 4, 2];
const GROUP_ANGLE_PASSES = 3;
